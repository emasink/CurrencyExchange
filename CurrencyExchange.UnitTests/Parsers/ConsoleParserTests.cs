...
namespace CurrencyExchange.UnitTests.Parsers;
...
public class ConsoleParserTests
{
    ...
    [InlineData("EUR/123 10", 10, "EUR", "123")]
    public void Parse_WhenValidRequest_ReturnExchangeRequest(string input, decimal amount, string mainCurrencyCode,
    ...
    [InlineData("cur /cur 1", "source currency")]
